                        ...
                        <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" data-placeholder="Choose Client"
                                                ...
                                                @foreach($clients as $client)
                                                    <option
                                                        @if($estimate->client_id == $client->user_id) selected @endif
                                                        value="{{ $client->user_id }}">{{ ucwords($client->user->name) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12  visible-md visible-lg">
                                        ...
                                        <div class="@if($invoiceSetting->hsn_sac_code_show) col-md-3 @else col-md-4 @endiffont-bold" style="padding: 8px 15px">
                                                ...
                                                <div class="col-xs-12 item-row margin-top-5">
                                                    ...
                                                    @if($invoiceSetting->hsn_sac_code_show)
                                                        <div class="col-md-1">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ $item->quantity }}"  name="hsn_sac_code[]" >
