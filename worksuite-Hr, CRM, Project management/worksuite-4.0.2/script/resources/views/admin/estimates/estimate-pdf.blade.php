            ...
            <td>
                <div id="invoiced_to">
                    @if(!is_null($estimate->client))
                        ...
                        <h2 class="name">{{ $estimate->client->client_details->company_name ?? ucwords($estimate->client->name) }}</h2>
                        <div>{!! nl2br($estimate->client->client_details->address) !!}</div>
                    @endif
                </div>
            </td>
            <td>
...
<main>
    ...
    @if($estimate->sign)
        <div style="text-align: right;">
            <h2 class="name" style="margin-bottom: 20px;">@lang('app.signature') ({{ $estimate->client->name }})</h2>
